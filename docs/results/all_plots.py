# This script is from Stable Baselines Zoo. Here only a smoothing option was added.
...
parser.add_argument("-s", "--smooth", help="Smooth: convolution filter size", type=int, default=1)
parser.add_argument(
    "-k",
    "--key",
